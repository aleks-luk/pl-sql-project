...
-- INSERT ON PRODUCTS TABLE
INSERT INTO products(product_name)
SELECT 'telewizor' AS product_name  FROM DUAL UNION ALL
SELECT 'pralka' 					FROM DUAL UNION ALL
SELECT 'komputer' 					FROM DUAL UNION ALL
SELECT 'termomix' 					FROM DUAL UNION ALL
SELECT 'lampka' 					FROM DUAL UNION ALL
SELECT 'biurko' 					FROM DUAL
;


-- INSERT ON CUSTOMERS TABLE
INSERT INTO customers(customer_id, first_name, last_name, is_company) VALUES (1, 'Jacek', 'Borkowski' ,'N');
INSERT INTO customers(customer_id, first_name, last_name, is_company) VALUES (2, 'Karol', 'Jendrzejczyk' ,'T');
INSERT INTO customers(customer_id, first_name, last_name, is_company) VALUES (3, 'Krystyna', 'Koprowska' ,'N');
INSERT INTO customers(customer_id, first_name, last_name, is_company) VALUES (4, 'Janusz', 'Toczek' ,'T');


-- INSERT ON CUSTOMER_ORDERS TABLE
INSERT INTO customer_orders(order_id, order_date, customer_id, product_id, quantity) VALUES (1, TO_DATE('2021-08-16', 'YYYY-MM-DD'), 2, 4, 200);
INSERT INTO customer_orders(order_id, order_date, customer_id, product_id, quantity) VALUES (2, TO_DATE('2021-06-18', 'YYYY-MM-DD'), 4, 2, 150);
INSERT INTO customer_orders(order_id, order_date, customer_id, product_id, quantity) VALUES (3, TO_DATE('2021-11-05', 'YYYY-MM-DD'), 1, 2, 20);
INSERT INTO customer_orders(order_id, order_date, customer_id, product_id, quantity) VALUES (4, TO_DATE('2021-12-31', 'YYYY-MM-DD'), 1, 1, 1000);
INSERT INTO customer_orders(order_id, order_date, customer_id, product_id, quantity) VALUES (5, TO_DATE('2021-09-05', 'YYYY-MM-DD'), 3, 6, 220);
INSERT INTO customer_orders(order_id, order_date, customer_id, product_id, quantity) VALUES (6, TO_DATE('2021-01-14', 'YYYY-MM-DD'), 2, 5, 330);
INSERT INTO customer_orders(order_id, order_date, customer_id, product_id, quantity) VALUES (7, TO_DATE('2021-06-22', 'YYYY-MM-DD'), 4, 3, 840);


-- INSERT ON JOB_LIMITS TABLE
INSERT INTO job_limits(id_limit, job_id, days_left) VALUES (1, 'AD_ASST', 25);
INSERT INTO job_limits(id_limit, job_id, days_left) VALUES (2, 'FI_ACCOUNT', 80);
INSERT INTO job_limits(id_limit, job_id, days_left) VALUES (3, 'AC_ACCOUNT', 92);
INSERT INTO job_limits(id_limit, job_id, days_left) VALUES (4, 'ST_MAN', 15);
INSERT INTO job_limits(id_limit, job_id, days_left) VALUES (5, 'ST_CLERK', 65);
INSERT INTO job_limits(id_limit, job_id, days_left) VALUES (6, 'IT_PROG', 40);
INSERT INTO job_limits(id_limit, job_id, days_left) VALUES (7, 'PU_CLERK', 41);
INSERT INTO job_limits(id_limit, job_id, days_left) VALUES (8, 'PR_REP', 38);

-- INSERT ON ORDER_PAYMENTS TABLE
INSERT INTO order_payments(payment_id, payment_date, order_ID, status) VALUES (1, TO_DATE('2021-08-16', 'YYYY-MM-DD'), 1, 'PENDING');
INSERT INTO order_payments(payment_id, payment_date, order_ID, status) VALUES (2, TO_DATE('2021-08-16', 'YYYY-MM-DD'), 1, 'APPROVED');
INSERT INTO order_payments(payment_id, payment_date, order_ID, status) VALUES (3, TO_DATE('2021-06-18', 'YYYY-MM-DD'), 2, 'PENDING');
INSERT INTO order_payments(payment_id, payment_date, order_ID, status) VALUES (4, TO_DATE('2021-06-18', 'YYYY-MM-DD'), 2, 'APPROVED');
INSERT INTO order_payments(payment_id, payment_date, order_ID, status) VALUES (5, TO_DATE('2021-11-05', 'YYYY-MM-DD'), 3, 'PENDING');
INSERT INTO order_payments(payment_id, payment_date, order_ID, status) VALUES (6, TO_DATE('2021-11-05', 'YYYY-MM-DD'), 3, 'APPROVED');
INSERT INTO order_payments(payment_id, payment_date, order_ID, status) VALUES (7, TO_DATE('2021-12-31', 'YYYY-MM-DD'), 4, 'CANCELED');
